Feature: Blog page
  ...
  Scenario:  Viewing an individual article
    ...
    And I click on article titled "What is Lorem Ipsum?"
    Then I should be on the article page for "What is Lorem Ipsum?"
    And I should see the full text of the article "What is Lorem Ipsum?"
    And I should see the article photo for "What is Lorem Ipsum?"
